...
module.exports = {
  ...
  // Configurations pour la surveillance
  watch: true,  // Active le mode de surveillance

  watchOptions: {
    aggregateTimeout: 200, // Ajoute un délai avant de reconstruire une fois que le premier fichier a changé
